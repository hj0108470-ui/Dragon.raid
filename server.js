...
// 🎮 1. 메인 플레이 페이지 (Cannot GET 방지용 라우트)
app.get('/', (req, res) => {
    ...
    <head>
        ...
        <style>
            ...
            .boss-card, .player-card { background: #222; border-radius: 12px; padding: 15px; margin-bottom: 15px; border: 1px solid #444; }
